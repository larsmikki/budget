...
export default function SettingsPage() {
  ...
  const handleExport = () => {
    ...
    a.href = url
    a.download = `spendr-${state.year}.json`
    a.click()
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-sm mt-0.5 text-text2">Customize Spendr to your preferences.</p>
      </div>

      <Surface className="p-6 mb-5">
        <h2 className="text-base font-bold mb-1 text-text">Themes</h2>
        <p className="text-xs mb-5 text-text2">Choose how Spendr looks to you.</p>
